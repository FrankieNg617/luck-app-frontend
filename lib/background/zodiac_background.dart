...
class ZodiacBackground extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ZodiacBackground> createState() => _ZodiacBackgroundState();
}

class _ZodiacBackgroundState extends State<ZodiacBackground>
