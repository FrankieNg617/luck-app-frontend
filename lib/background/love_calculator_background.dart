...
class LoveCalculatorBackground extends StatefulWidget {
  final Widget child;

  const LoveCalculatorBackground({
    super.key,
    required this.child,
  });

  @override
  State<LoveCalculatorBackground> createState() => _LoveCalculatorBackgroundState();
}

class _LoveCalculatorBackgroundState extends State<LoveCalculatorBackground>
  ...
  void initState() {
    ...
    _dotStars = List.generate(120, (i) => _DotStar.random(rng));
  }
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        // ================= BACKGROUND IMAGE =================
        Image.asset(
          'assets/backgrounds/love_cal_background.png',
          fit: BoxFit.cover,
