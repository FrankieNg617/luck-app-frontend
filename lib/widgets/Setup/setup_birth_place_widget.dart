...
class _SetupBirthPlaceWidgetState extends State<SetupBirthPlaceWidget> {
  ...
  Future<void> _openPlaceSearchSheet() async {
    final selected = await showModalBottomSheet<SetupPlaceSelection>(
      ...
      builder: (_) => const _BirthPlaceSearchSheet(),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final fieldHeight = (media.size.height * 0.050).clamp(40.0, 54.0);
            ...
            child: Padding(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final buttonHeight = widget.buttonHeight.clamp(52.0, 64.0);
                    ...
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: widget.titleFontSize.clamp(
                                        28,
                                        42,
                                      ),
                                  ...
                                  SizedBox(
                                    height: (availableHeight * 0.015).clamp(
                                      10.0,
                                      16.0,
                                    ),
                                  ),
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontSize: widget.bodyFontSize.clamp(
                                        13,
                                        17,
                                      ),
                                  ...
                                  SizedBox(
                                    height: (availableHeight * 0.045).clamp(
                                      20.0,
                                      40.0,
                                    ),
                                  ),
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                          bottom: (availableHeight * 0.03).clamp(12.0, 24.0),
                        ),
                        child: SizedBox(
                          width: double.infinity,
                          height: buttonHeight,
